...
#define RIGHT_CHILD_PAGE_NUM_SIZE sizeof(uint32_t)
#define RIGHT_CHILD_CREATED_XID_SIZE sizeof(Xid)
#define RIGHT_CHILD_EXPIRED_XID_SIZE sizeof(Xid)
#define RIGHT_CHILD_SIZE  (RIGHT_CHILD_PAGE_NUM_SIZE + RIGHT_CHILD_CREATED_XID_SIZE + RIGHT_CHILD_EXPIRED_XID_SIZE)
...
// PAGE_NUM + CREATED_XID + EXPIRED_XID
#define INTERNAL_NODE_CELL_PAGE_NUM_SIZE sizeof(uint32_t)
#define INTERNAL_NODE_CELL_CREATED_XID_SIZE sizeof(Xid)
#define INTERNAL_NODE_CELL_EXPIRED_XID_SIZE sizeof(Xid)
#define INTERNAL_NODE_CELL_CHILD_SIZE  (INTERNAL_NODE_CELL_PAGE_NUM_SIZE + INTERNAL_NODE_CELL_CREATED_XID_SIZE + INTERNAL_NODE_CELL_EXPIRED_XID_SIZE)
