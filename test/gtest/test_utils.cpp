...
TEST(utils, stof) {
    float ret;
    ASSERT_EQ(stof("12121321312312312312312314123124134742748723743772472384732874894872374327489273481784723374723487283478237487324.277761327462839188378274372747234762374672364762874672647627467236472647627346723648726347234678236476234757823748572985782738582749823784728374", &ret), -1);
    ASSERT_EQ(stof("12.232323u", &ret), 0);
    ASSERT_EQ(stof("0.23", &ret), 1);
    ASSERT_EQ(ret, 0.23f);
}
...
TEST(utils, stod) {
    double ret;
    ASSERT_EQ(stod("12121321312312312312312314123124134742748723743772472384732874894872374327489273481784723374723487283478237487324.277761327462839188378274372747234762374672364762874672647627467236472647627346723648726347234678236476234757823748572985782738582749823784728374", &ret), 1);
    ...
    ASSERT_EQ(stod("12.232323u", &ret), 0);
    ASSERT_EQ(stod("0.23", &ret), 1);
    ASSERT_EQ(ret, 0.23);
}
